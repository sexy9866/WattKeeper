...
if(! class_exists("Constants") )
{
	class Constants {
		/* 개발서버 */
		var $excelSavePath			= "C:/php_workspafe/WattKeeper/upload_excel" ;
		var $fileSavePath			= "C:/php_workspafe/WattKeeper/upload_img" ;
		var $fileSavePath_720		= "C:/php_workspafe/WattKeeper/720" ;				// linux 경로
		var $fileSavePath_640		= "C:/php_workspafe/WattKeeper/640" ;				// linux 경로
		var $fileSavePath_480		= "C:/php_workspafe/WattKeeper/480" ;				// linux 경로
		var $fileSavePath_320		= "C:/php_workspafe/WattKeeper/320" ;				// linux 경로
		var $fileSavePath_100		= "C:/php_workspafe/WattKeeper/100" ;				// linux 경로
		var $agreeInfoPath			= "C:/php_workspafe/WattKeeper/setting/agree.txt";	// 이용약관 파일 경로
		var $privacyInfoPath		= "C:/php_workspafe/WattKeeper/setting/privacy.txt";	// 개인정보취급방침 파일 경로

		var $logPath				= "C:/Users/a/workspace_php/WattKeeper/log" ;	// simple 로그기록
		var $documentRoot			= "C:/Users/a/workspace_php/WattKeeper/" ;	// simple 로그기록
		var $webRoot				= "http://106.240.232.36:8300" ;
		var $con_domain				= "http://106.240.232.36:8300" ;	// 메일에서 사용되는 도메인

<script>
	$(document).ready(function(){
		...
		function lastPostFunc()  {  
		    ...
		    $.ajax({
				url : "/action_front.php?cmd=ApiGeneral.getDietList",
				async : false,
				cache : false,
				dataType : 'json',
				data : {
				...
				success : function(data){
			        if (data.length != 0) {
				        ...
				        var html = "<li onClick=\"window.location.href=\'dietDetail.php?dNumber=" + data[i]['dNumber'] + "\';\"> <a>" + data[i]['dName'] + "</a> <img src='../image/btn_list_next.png' width='25'/></li>";
